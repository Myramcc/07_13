...
class XXLJOBPOC(POCBase):
    ...
    name = "SKY——后台存在弱口令漏洞"  # PoC 名称
    appPowerLink = "sky"  # 漏洞厂商主页地址
    appName = "sky"  # 漏洞应用名称
    ...
    def _check(self):
        ...
        cookies = {"SESSID": "f9d4220c1ea69b31c3cea5fe300e101c"}
        ...
        res = requests.post(url=url, headers=headers, cookies=cookies, data=data, verify=False, timeout=9)
        result = []
